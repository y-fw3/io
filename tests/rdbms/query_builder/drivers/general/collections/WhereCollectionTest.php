 ...
 * WhereCollectionテスト
 */
class WhereCollectionTest extends AbstractQueryBuilderTestCase
{
    public function testOperator()
    {
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_EQ)->build();
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_NULL_SAFE_EQ)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_IN)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_N_IN)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_N_EQ)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_LT)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_GT)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_LT_EQ)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_GT_EQ)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, true,  Query::OP_IS)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, false,  Query::OP_IS)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, null,  Query::OP_IS)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, true,  Query::OP_N_IS)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, false,  Query::OP_N_IS)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, null,  Query::OP_N_IS)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, [1, 2],  Query::OP_BETWEEN)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, [1, 2],  Query::OP_N_BETWEEN)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_LIKE)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_N_LIKE)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_SOUNDS_LIKE)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_REGEX)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($messageIdColumn, 1,  Query::OP_NOT_REGEX)->build();
        $this->assertBuildResult($expected, $actual);
    }
    ...
    public function testLeftExpression()
    {
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($where, Spec::messageIdColumn())->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($expression, Spec::messageIdColumn())->build();
        $this->assertBuildResult($expected, $actual);
    ...
    public function testRightExpression()
    {
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where(Spec::messageIdColumn(), $where)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where(Spec::messageIdColumn(), $expression)->build();
        $this->assertBuildResult($expected, $actual);
    ...
    public function testLiteral()
    {
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where(Spec::messageIdColumn(), $literal)->build();
        $this->assertBuildResult($expected, $actual);
        ...
        $actual     = WhereCollection::factory()->table(Spec::TABLE_NAME)->where($literal, Spec::messageIdColumn())->build();
        $this->assertBuildResult($expected, $actual);
