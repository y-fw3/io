    ...
    TablePropertyInterface
{
     ...
     * @return  InsertClause    Insert述部
     */
    public static function factory(...$arguments): InsertClause
    {
        return new static();
    }
     ...
     * テーブルを取得・設定します。
     *
     * @param   null|string|TableReferenceExpression||InsertClause  $table  テーブル参照
     * @param   null|string|TableReferenceExpression||InsertClause  $alias  テーブル参照別名
     * @return  InsertClause|TableReferenceExpression               このインスタンスまたはテーブル
     */
