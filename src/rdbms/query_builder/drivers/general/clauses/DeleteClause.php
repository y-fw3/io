    ...
    TablePropertyInterface
{
     ...
     */
    public static function factory(...$arguments): DeleteClause
    {
        return new static();
    }
     ...
     * テーブルを取得・設定します。
     *
     * @param   null|string|TableReferenceExpression||DeleteClause  $table  テーブル参照
     * @param   null|string|TableReferenceExpression||DeleteClause  $alias  テーブル参照別名
     * @return  DeleteClause|TableReferenceExpression               このインスタンスまたはテーブル
     */
